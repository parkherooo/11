...
<div class="min">
	...
	<div class="main_container">
		<div class="middle_Top">
			...
			<ul>
				<li class="my_account"><a href="#" type="text"> <!-- 세션에서 가져온 userId 표시 -->
						<%=(String) session.getAttribute("userId") != null ? (String) session.getAttribute("userId") : "root"%>
				</a></li>
			</ul>
			<ul>
				<li><a href="post_update.jsp?cuNum=<%=post.getCuNum()%>"><img
						class="dot" src="img/수정아이콘.png" alt="dot"></a></li>
			</ul>
		</div>
		...
		<div class="middle_Box">
			<div class="post_item">
				<img class="photo"
					src="upload/<%=post.getCuImg() != null ? post.getCuImg() : "default.png"%>"
					alt="photo" />
			</div>
		</div>
							...
							<li>
								<div>
									...
									<button class="deleteBtn"
										onclick="deleteComment(<%=comment.getCmNum()%>)">삭제</button>
								</div>
							</li>
							<%
							}
		...
		<div class="middle_add_review">
			...
			<form method="post">
				...
				<input class="input_review" type="text" name="comment"
					...
					name="cuNum" value="<%=post.getCuNum()%>" />
